...
{					     
	...
	GPIO_Init(GPIOB,SCL_PIN,GPIO_DIR_OUT,GPIO_PULL_UP_NOT,GPIO_PULL_DOWN_NOT,GPIO_OUT_PP);
...
void MPU_IIC_Start(void)
{
	...
	MPU_IIC_Delay();
	POUT(SCL_PIN,0);//钳住I2C总线，准备发送或接收数据 
}	  
//产生IIC停止信号
